...
os.system("{kubectl} delete namespace {namespace}".format(kubectl = config.kubectl_command, namespace=config.namespace))

os.system("{kubectl} config set-context --current --namespace={namespace}".format(kubectl = config.kubectl_command, "default")
